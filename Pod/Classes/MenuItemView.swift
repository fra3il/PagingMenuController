...
open class MenuItemView: UIView {
    ...
    fileprivate func layoutMultiLineLabel() {
        ...
        NSLayoutConstraint.activate([
            ...
            descriptionLabel.bottomAnchor.constraint(equalTo: bottomAnchor, constant: verticalMargin * -1),
...
extension MenuItemView {
    ...
    fileprivate func estimatedLabelSize(_ label: UILabel) -> CGSize {
        ...
        return NSString(string: text).boundingRect(with: CGSize(width: CGFloat.greatestFiniteMagnitude, height: CGFloat.greatestFiniteMagnitude), options: .usesLineFragmentOrigin, attributes: [.font: label.font], context: nil).size
    }
